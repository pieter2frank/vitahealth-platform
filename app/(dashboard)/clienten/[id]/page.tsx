...
export default async function ClientDetailPage({
  ...
  const [
    ...
    supabase
      .from('vh_report')
      .select('id, sample_id, sample_date, metabolic_age, resilience_score, resilience_percentile, resilience_category, parse_status, warnings, vh_report_disease_risk(disease, result_category, risk_current_pct, risk_age70_pct), vh_report_biomarker(marker_code, value, value_qualifier, unit, ref_optimal, association)')
      .eq('client_id', id)
