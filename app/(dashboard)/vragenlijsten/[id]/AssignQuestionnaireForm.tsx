...
export function AssignQuestionnaireForm({ questionnaireId, clients }: Props) {
  ...
  async function handleAssign(e: React.FormEvent) {
    ...
    const { error: dbErr } = await supabase
      ...
      .insert({ questionnaire_id: questionnaireId, client_id: clientId })
    ...
    setSuccess(`Toegewezen aan ${name}.`)
    setClientId('')
    setSaving(false)
    router.refresh()
  }
