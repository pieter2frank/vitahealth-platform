...
|---|---|---|---|---|---|
| Supabase | Automatisch — DPA "forms part of the Supabase Terms of Service" (geaccepteerd bij accountaanmaak) | Version 1 — August 1, 2026 | 18-08-2026 | ✔ `dpa-supabase-v1-aug2026.pdf` + TIA (`Supabase+TIA+250314.pdf`) | ✔ in DPA/TIA-bijlagen (AWS, EU-regio) |
| Zivver | Standaard-DPA van zivver.com/legal/data-processing (gekoppeld aan de hoofdovereenkomst; desgewenst bevestiging vragen bij accountbeheer) | zie PDF | 18-08-2026 | ✔ `dpa-zivver.pdf` | ✔ in DPA-bijlagen |
...
| Resend | **Ondertekende DPA** (self-serve via resend.com/legal/dpa), incl. SCC's voor VS-doorgifte. Extra assurance in map: SOC 2 Type II-rapport + pentest-attestatie | zie PDF | 18-08-2026 | ✔ `resend-dpa-signed.pdf` (+ `resend-soc-2-type-ii-report.pdf`, `resend-pen-test-letter-of-attestation.pdf`) | ✔ in DPA-annex (AWS e.a.) |
| Better Stack | Automatisch — standaard-DPA op betterstack.com/dpa geldt voor "the Better Stack customer identified on the ordering document" (incl. SCC's voor VS-doorgifte). NB: Schedule B gaat uit van géén gevoelige data — klopt met ons gebruik (auditlog-kopie is pseudoniem: ids + gehashte IP's, geen medische inhoud) | Last Updated: Feb 25, 2025 (schedules: Feb 14, 2025) | 18-08-2026 | ✔ `dpa-betterstack.pdf` | ✔ `subverwerkers-betterstack.pdf` (Schedule A: o.a. AWS/VS, Google Ierland, Cloudflare, Hetzner/EU) |
