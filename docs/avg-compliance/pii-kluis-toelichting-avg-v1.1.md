...
| **Status** | Definitief — maatregel volledig uitgevoerd (13 augustus 2026) |
| **Doelgroep** | AVG-functionaris / privacy-verantwoordelijke |
| **Technisch zusterdocument** | `pii-kluis-implementatieplan-v1.1` |
| **Wijzigingen v1.1** | Hoofdstuk 5 bijgewerkt: de afsluitende stap is uitgevoerd; de oude onversleutelde velden bestaan niet meer. |
...
en is op **13 augustus 2026 volledig afgerond**: na een gecontroleerde afsluiting (verse
backup, rooktest op productie en een expliciete go) zijn de oude, onversleutelde velden
definitief uit de database verwijderd. Gecontroleerd is dat de dossiertabel nu uitsluitend
pseudonieme velden bevat. Vanaf dit moment is een databasediefstal daadwerkelijk naamloos.

Als vervolgstappen staan gepland: het formeel vastleggen van de sleutelrotatie-procedure en
het activeren van het retentiebeleid (dossiers anonimiseren na afloop van de bewaartermijn
door de kluisregel te verwijderen).
