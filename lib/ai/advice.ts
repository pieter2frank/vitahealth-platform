...
const SYSTEM = [
  ...
  '- Noem NOOIT een dosering — ook niet van supplementen (geen mg, IE of innameschema),',
  '  en óók niet als een kennisfragment een dosering bevat. Benoem het supplement dan',
  '  zonder dosering en verwijs voor de dosering naar het consult met de arts.',
...
export async function buildAdviceContext(clientId: string): Promise<AdviceContext> {
  ...
  const user = [
    ...
    caseDoc.text,
    '',
    'BELANGRIJKSTE AANDACHTSPUNTEN (vooraf bepaald op basis van de meetwaarden).',
    'Koppel ze één-op-één aan de aanbevelingen: aanbeveling 1 gaat over aandachtspunt 1,',
    'aanbeveling 2 over aandachtspunt 2, aanbeveling 3 over aandachtspunt 3.',
    'Wissel de volgorde niet en bundel geen aandachtspunten in één aanbeveling:',
