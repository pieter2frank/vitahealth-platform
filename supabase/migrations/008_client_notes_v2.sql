-- Vita Health — vervang vh_client_note door meerdere notities per cliënt
-- Uitvoeren via Supabase SQL Editor

-- Verwijder oude tabel (had één rij per cliënt)
drop table if exists vh_client_note;

-- Nieuwe tabel: meerdere notities per cliënt
