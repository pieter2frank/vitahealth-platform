-- Migratie 022: check_enrollment_email en resolve_intake_token geven nu ook
-- adresdata terug, zodat de form stap 2 kan tonen als adres ontbreekt
-- en bestaande gegevens kan voorinvullen.
...
declare
  ...
  v_assignment  uuid;
begin
  select id, enrollment_status, first_name, last_name,
