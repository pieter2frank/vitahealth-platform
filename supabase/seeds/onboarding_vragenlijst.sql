...
values (
  ...
  $json$
  {
    ...
    "questions": [
      ...
      { "id": "d4_klachten",   "type": "rating_10", "label": "Hoeveel last ervaar je momenteel van lichamelijke klachten?",                                                                            "category": "Klachten, energie en zelfzorg", "leftLabel": "Geen last",        "rightLabel": "Veel last",          "required": true, "reversed": true },
      ...
      { "id": "d4_patronen",   "type": "rating_10", "label": "Ik vind het soms lastig om gezonde keuzes te maken, ook al weet ik wat goed voor me is.",                                                "category": "Klachten, energie en zelfzorg", "leftLabel": "Helemaal niet", "rightLabel": "Volledig", "required": true, "reversed": true },
      ...
      { "id": "d5_wearable", "type": "boolean", "label": "Houd je gegevens over je gezondheid, beweging en slaap bij met een wearable (bv. Garmin, Polar, Apple Watch, Fitbit, etc.)?", "category": "Motivatie & doelen", "required": true },
      { "id": "d5_data_delen", "type": "radio", "label": "Zou je dit soort gegevens willen delen met dit platform, zodat we gerichter kunnen adviseren hoe je je gezondheid en vitaliteit kunt verbeteren?", "category": "Motivatie & doelen", "required": true,
        "options": [
          { "value": "ja",        "label": "Ja" },
          { "value": "nee",       "label": "Nee" },
      ...
      { "id": "d5_data_delen_opmerking", "type": "long_text", "label": "Heb je hier een opmerking over? (optioneel)", "category": "Motivatie & doelen", "required": false }
    ]
  }
  $json$
)
